...
export default function SignInScreen() {
  ...
  const handleLogin = async () => {
    ...
    const result = await login(identifier.trim(), pin.trim());
    setLoading(false);
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <TextInput
          {...authTextInputProps}
          placeholder="Email or cellphone number"
          autoCapitalize="none"
        ...
        <View style={styles.passwordRow}>
          ...
          />
          <Pressable onPress={() => setShowPin((prev) => !prev)} style={styles.passwordToggle}>
            <Text style={styles.passwordToggleText}>{showPin ? "Hide" : "Show"}</Text>
          </Pressable>
        </View>
