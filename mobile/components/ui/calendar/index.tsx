...
const Menu = ({ children, trigger }: any) => <View>{trigger({})} {children}</View>;
const MenuItem = ({ children, onPress }: any) => <Pressable onPress={onPress}>{children}</Pressable>;
const MenuItemLabel = ({ children }: any) => <Text>{children}</Text>;
import {
  calendarBodyStyle,
