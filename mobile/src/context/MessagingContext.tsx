...
export function MessagingProvider({ children }: { children: ReactNode }) {
    ...
    const toggleLike = async (replyId: string, userId: string) => {
        ...
        const newLikes = liked ? reply.likes.filter((id: string) => id !== userId) : [...reply.likes, userId];
    ...
    const toggleSubscription = async (discussionId: string, userId: string) => {
        ...
        const newSubs = subbed ? disc.subscribedUserIds.filter((id: string) => id !== userId) : [...disc.subscribedUserIds, userId];
